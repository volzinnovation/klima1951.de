...
import json
import datetime
yearNr =datetime.datetime.now().year 
year = str(yearNr)
base_dir = "json"
        ...
        if os.path.isdir(x_dir):
            for y in os.listdir(x_dir):
                ...
                if os.path.isdir(y_dir):
                    ...
                    input_filepath = os.path.join(y_dir, f"all1951-{yearNr-1}.json")

                    output_filepath = os.path.join(y_dir, f"all1951-{yearNr}.json")
                    all_combined_data = {}
                    ...
                    if os.path.exists(input_filepath):
                        ...
                        with open(input_filepath, 'r') as f:
                            try:
                                ...
                                print(f"An error occurred while processing file {input_filepath}: {e}")
